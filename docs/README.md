...
- **[DECISIONS.md](DECISIONS.md)** — current state, next step, locked decisions. **Read first.**
- **plans/** — [v1 engineering plan](plans/2026-06-28-nac-code-v1-engineering-plan.md): scope, architecture, interface contracts, milestones.
- **specs/** — [M0-agent-runtime-and-context.md](specs/M0-agent-runtime-and-context.md): agent runtime + adapter interface (M0-1) and provider-neutral transcript + cross-provider context (M0-8).
